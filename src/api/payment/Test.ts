...
export = (app: any) => {
    ...
    app.post('/test/payment/ewallet', auth, async (req: Request, res: Response) => {
    ...
    app.get('/test/payment/ewallet/:id', auth, async (req: Request, res: Response) => {
        try {
    ...
    app.get('/test/payment/transaction', async (req: Request, res: Response) => {
        try {
