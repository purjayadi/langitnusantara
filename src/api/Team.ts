...
export = (app:any) => {
  ...
  app.post('/team', auth, isAdmin, upload.single('photo'), async (req: Request, res: Response) => {
      const payload:ITeam = {
        name: req.body.name,
        photo: req.file?.path,
  ...
  app.patch('/team/:id', auth, isAdmin, upload.single('photo'), async (req: Request, res: Response) => {
      const payload:ITeam = {
        name: req.body.name,
        photo: req.file?.path,
        position: req.body.position,
  ...
  app.delete('/team/:id', auth, isAdmin, async (req: Request, res: Response) => {
    try {
  ...
  app.get('/team/:id', auth, isAdmin, async (req: Request, res: Response) => {
    try {
